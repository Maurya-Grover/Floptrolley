...
exports.getAll = async (_req, res, _next) => {
...
exports.createNew = async (req, res, _next) => {
...
exports.getByID = async (req, res, _next) => {
...
exports.updateById = async (req, res, _next) => {
	const id = req.params.productId;
...
exports.deleteById = async (req, res, _next) => {
	const id = req.params.productId;
